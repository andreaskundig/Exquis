...
parentId is generated in tabs.js, which currently just returns a method refreshActiveTab
It should instead return an object {refreshActiveTab, getParentId/Div(tabName)}
