...
* bugs
** probleme de chargement d'une animation, pas a chaque fois 
(en enregistrer une d'abord peut-etre)
** editeur reste 'invisible'
button row devrait être utilisé par ace et blockly
* ui
