...
requirejs(['paramsManager'], function(paramsManager){
    ...
    testDefineWithObject(paramsManager);
    testDefineWithFunction(paramsManager);
    
    console.log("all tests passed");
});

function testDefineWithObject(paramsManager){
    const mgr = paramsManager();
...
function testDefineWithFunction(paramsManager){
    const mgr = paramsManager();
    
    const rootAst = mgr.parseCodeString(programWithFunction);
    // console.log(JSON.stringify(rootAst, null, 2)); 
